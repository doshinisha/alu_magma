...
class SimpleALU(m.Circuit):
    ...
    #m.compile("build/alu", SimpleALU, output="coreir-verilog")
...
def test_simple_alu():
    ...
    #tester.compile_and_run("verilator", dump_waveforms, flags=["-Wno-fatal"], directory="build")
    #tester.compile_and_run("system-verilog", simulator="verilator", flags=["-Wno-fatal"], directory="build")
